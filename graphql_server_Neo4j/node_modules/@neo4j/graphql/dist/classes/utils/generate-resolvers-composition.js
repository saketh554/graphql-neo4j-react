...
exports.generateResolverComposition = void 0;
const check_authentication_1 = require("../../translate/authorization/check-authentication");
function generateResolverComposition({ schemaModel, isSubscriptionEnabled, queryAndMutationWrappers, subscriptionWrappers, }) {
    ...
    resolverComposition[`Query.${customResolverQueryPattern}`] = [
        ...
        (0, check_authentication_1.isAuthenticated)(["READ"], schemaModel.operations.Query),
    ];
    ...
    resolverComposition[`Mutation.${customResolverMutationPattern}`] = [
        ...queryAndMutationWrappers,
        (0, check_authentication_1.isAuthenticated)(["CREATE", "UPDATE", "DELETE"], schemaModel.operations.Mutation),
    ];
...
exports.generateResolverComposition = generateResolverComposition;
...
//# sourceMappingURL=generate-resolvers-composition.js.map