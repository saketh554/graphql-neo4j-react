...
export declare const LIBRARY_DIRECTIVES: readonly [...("key" | "cypher" | "id" | "default" | "authentication" | "jwt" | "authorization" | "coalesce" | "customResolver" | "filterable" | "fulltext" | "jwtClaim" | "limit" | "mutation" | "plural" | "populatedBy" | "private" | "query" | "relayId" | "selectable" | "settable" | "subscription" | "timestamp" | "unique" | "vector" | "subscriptionsAuthorization")[], "alias", "relationship", "relationshipProperties", "declareRelationship", "node", "shareable"];
