...
function createSetRelationshipPropertiesAndParams({ properties, varName, relationship, operation, callbackBucket, }) {
    ...
    [...relationship.primitiveFields, ...relationship.temporalFields].forEach((field) => (0, callback_utils_1.addCallbackAndSetParam)(field, varName, propertiesObj, callbackBucket, strs, operation));
