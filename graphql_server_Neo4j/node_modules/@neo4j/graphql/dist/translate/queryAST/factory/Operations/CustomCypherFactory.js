...
const CypherOperation_1 = require("../../ast/operations/CypherOperation");
...
class CustomCypherFactory {
    ...
    createCustomCypherOperation({ resolveTree, context, entity, cypherAttributeField, cypherArguments = {}, }) {
        ...
        if (!entity) {
            return new CypherScalarOperation_1.CypherScalarOperation(selection, cypherAttributeField, true);
        }
        if ((0, is_concrete_entity_1.isConcreteEntity)(entity)) {
            const customCypher = new CypherOperation_1.CypherOperation({
    ...
    createTopLevelCustomCypherOperation({ resolveTree, context, entity, }) {
        ...
        if (!entity) {
            return new CypherScalarOperation_1.CypherScalarOperation(selection, operationField, false);
        }
        if ((0, is_concrete_entity_1.isConcreteEntity)(entity)) {
            const customCypher = new CypherOperation_1.CypherOperation({
