...
exports.FulltextSelection = void 0;
...
class FulltextSelection extends EntitySelection_1.EntitySelection {
    ...
    apply(context) {
        ...
        const phraseParam = new cypher_builder_1.default.Param(this.fulltext.phrase);
        const indexName = new cypher_builder_1.default.Literal(this.fulltext.index);
        const fulltextClause = cypher_builder_1.default.db.index.fulltext
        ...
        fulltextClause.where(cypher_builder_1.default.and(...whereOperators));
        return {
...
exports.FulltextSelection = FulltextSelection;
//# sourceMappingURL=FulltextSelection.js.map