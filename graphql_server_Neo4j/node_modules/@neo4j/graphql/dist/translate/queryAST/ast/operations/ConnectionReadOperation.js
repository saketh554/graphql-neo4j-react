...
class ConnectionReadOperation extends operations_1.Operation {
    ...
    transpile(context) {
        ...
        return {
            clauses: [
                cypher_builder_1.default.utils.concat(...extraMatches, selectionClause, ...filtersSubqueries, withWhere, withCollectEdgesAndTotalCount, unwindAndProjectionSubquery, returnClause),
            ],
