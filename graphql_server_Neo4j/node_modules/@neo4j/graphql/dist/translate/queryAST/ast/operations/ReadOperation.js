...
class ReadOperation extends operations_1.Operation {
    ...
    transpile(context) {
        ...
        if (isCreateSelection && !this.relationship) {
            ...
            clause = cypher_builder_1.default.utils.concat(...matchBlock, ...authFilterSubqueries, filterSubqueriesClause, filterSubqueryWith, sortAndLimitBlock, subqueries, ret);
        }
        return {
            clauses: [clause],
