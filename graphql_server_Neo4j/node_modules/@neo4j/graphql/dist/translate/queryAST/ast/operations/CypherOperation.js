...
class CypherOperation extends ReadOperation_1.ReadOperation {
    ...
    transpile(context) {
        ...
        const fieldSubqueries = cypher_builder_1.default.utils.concat(...this.getFieldsSubqueries(nestedContext), ...this.getCypherFieldsSubqueries(nestedContext));
        ...
        const clause = cypher_builder_1.default.utils.concat(matchClause, ...extraMatches, fieldSubqueries, ...authClauses, ret);
        return {
            clauses: [clause],
