...
exports.ValidRelationshipDeclaration = void 0;
...
function ValidRelationshipDeclaration(context) {
    ...
    const validateInterfaceOrObject = {
        leave(node, _key, _parent, path, ancestors) {
            ...
            const { isValid, errorMsg, errorPath } = (0, document_validation_error_1.assertValid)(() => assertRelationshipDeclaration({
                parentDef: node,
                interfaceToImplementationsMap,
...
exports.ValidRelationshipDeclaration = ValidRelationshipDeclaration;
function makeDeclareRelationshipDirectiveVisitorFn(addToRelationshipFieldsMap, context) {
    return function (directiveNode, _key, _parent, path, ancestors) {
        const [pathToNode, traversedDef, parentDef] = (0, path_parser_1.getPathToNode)(path, ancestors);
        if (!parentDef) {
