...
export declare const GraphQLDuration: GraphQLScalarType<import("neo4j-driver").Duration<number> | import("neo4j-driver").Duration<import("neo4j-driver-core/types/integer").default>, string>;
