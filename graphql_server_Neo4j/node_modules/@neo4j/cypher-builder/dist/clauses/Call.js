...
exports.Call = Call = __decorate([
    (0, mixin_1.mixin)(WithReturn_1.WithReturn, WithWith_1.WithWith, WithUnwind_1.WithUnwind, WithRemove_1.WithRemove, WithDelete_1.WithDelete, WithSet_1.WithSet, WithMatch_1.WithMatch, WithCreate_1.WithCreate, WithMerge_1.WithMerge, WithOrder_1.WithOrder)
], Call);
/**
 * @see [Cypher Documentation](https://neo4j.com/docs/cypher-manual/current/subqueries/call-subquery/#optional-call)
 * @category Clauses
